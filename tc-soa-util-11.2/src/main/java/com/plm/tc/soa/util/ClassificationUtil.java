...
import com.plm.tc.soa.clientx.AppXSharedSession;
...
public class ClassificationUtil {
    ...
    private static ModelObject[] getIcoByClassId(String classId) throws ServiceException {
        Classification.SearchClassAttributes[] response = new Classification.SearchClassAttributes[]{
                new Classification.SearchClassAttributes()};
