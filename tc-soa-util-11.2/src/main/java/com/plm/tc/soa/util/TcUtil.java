...
import com.plm.tc.soa.exception.SoaConnException;
import com.plm.tc.soa.exception.SoaUtilException;
...
public class TcUtil {
    ...
    public boolean deleteRelation(ModelObject primaryObject, ModelObject secondaryObject, String relationType) {
        ...
        ServiceData serviceData = dmService.deleteRelations(relationships);
